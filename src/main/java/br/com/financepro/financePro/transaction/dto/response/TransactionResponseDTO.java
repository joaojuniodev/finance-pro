...
public class TransactionResponseDTO {
    ...
    public int hashCode() {
        ...
        result = 31 * result + Objects.hashCode(getRecurrenceId());
        return result;
    }
}