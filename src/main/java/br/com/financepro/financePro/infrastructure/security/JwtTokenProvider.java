package br.com.financepro.financePro.infrastructure.security;

import br.com.financepro.financePro.data.dtos.security.TokenDTO;
import br.com.financepro.financePro.exceptions.InvalidJwtAuthenticationException;
...
public class JwtTokenProvider {
    ...
    public TokenDTO createAccessToken(String username, String fullName, List<String> roles) {
        ...
        return new TokenDTO(username, fullName, roles, true, now, validity, accessToken, refreshToken);
    }
