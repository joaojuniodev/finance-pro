...
public class MovementRequestDTO {
    ...
    public MovementRequestDTO(UUID id, BigDecimal amount, UUID fromWalletId, UUID toWalletId, LocalDateTime registeredAt) {
        this.id = id;
        this.amount = amount;
    ...
    public boolean equals(Object o) {
        ...
        MovementRequestDTO that = (MovementRequestDTO) o;
