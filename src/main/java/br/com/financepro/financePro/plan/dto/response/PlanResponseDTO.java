package br.com.financepro.financePro.plan.dto.response;
...
public class PlanResponseDTO {
    ...
    public PlanResponseDTO(UUID id, String name, String description, PlanType type, BigDecimal price, String currency, Boolean active, LocalDateTime createdAt, LocalDateTime updatedAt) {
        this.id = id;
        this.name = name;
    ...
    public boolean equals(Object o) {
        ...
        PlanResponseDTO that = (PlanResponseDTO) o;
