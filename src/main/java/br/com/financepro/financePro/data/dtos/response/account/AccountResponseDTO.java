package br.com.financepro.financePro.data.dtos.response.account;
...
public class AccountResponseDTO {
    ...
    public AccountResponseDTO(UUID id, BigDecimal currentBalance, BigDecimal income, BigDecimal expenses, BigDecimal netIncome, Category biggestExpense) {
        this.id = id;
